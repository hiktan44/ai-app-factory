...
const PROMPT_LABELS: Record<string, { label: string; description: string; llm: string }> = {
  ...
  architecture: { label: "2. Mimari Tasarım", description: "Uygulama mimarisi ve teknik spec", llm: "Gemini" },
  build: { label: "3. Kod Yazma", description: "Uygulama kodunun üretimi", llm: "Gemini" },
  verify_fix: { label: "4. Doğrulama & Düzeltme", description: "Build hataları ve düzeltmeler", llm: "Gemini" },
  ...
  marketing: { label: "7. Marketing", description: "EN/TR pazarlama metinleri", llm: "Gemini/Qwen" },
